 ...
 * +-------------+------+------+------+------+------+------+------+------+------+------+-------------+
 *               |  GUI |  Alt | MHEN |Space | Shift| Ctrl | Raise| HENK |  Alt |  GUI |
 *               +---------------------------------------------------------------------+
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   JP_LBRC,  JP_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
                    KC_LGUI, KC_LALT, JP_MHEN, KC_SPC, KC_LSFT,  KC_RCTRL, RAISE,   JP_HENK, KC_RALT, KC_RGUI\
),
...
/* Raise
 * +-----------------------------------------+             +-----------------------------------------+
 * |ZenHan|  F1  |  F2  |  F3  |  F4  |  F5  |             |  F6  |  F7  |  F8  |  F9  | F10  | Del  |
 * |------+------+------+------+------+------+             +------+------+------+------+------+------|
 * |      | F11  | F12  |Insert| PrtSc|      |             | Home | PgDn | PgUp | End  |      |      |
 * |------+------+------+------+------+------+             +------+------+------+------+------+------|
 * |      |      |      |      |      |      |             | Left | Down |  Up  | Right|  :*  |      |
 * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |  (   |  )   | End  |  \_  |  -=  |  ^~  |  \|  |      |
 ...
 */
[_RAISE] = LAYOUT( \
  JP_ZHTG, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                      KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL, \
  _______, KC_F11,  KC_F12,  KC_INS,  KC_PSCR, _______,                    KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______, \
  _______, _______, _______, _______, _______, _______,                    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, JP_COLN, _______, \
  _______, _______, _______, _______, _______, _______, JP_LPRN, JP_RPRN,  KC_END,  JP_BSLS, JP_MINS, JP_CIRC, JP_YEN,  _______, \
                    _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______\
),

/* Adjust (Lower + Raise) ※使用しない※
 * ,-----------------------------------------.             ,-----------------------------------------.
